...
(PA.05 mapped to LED2) with two different frequencies. please refer to UM1726 "Getting
started with the STM32 Nucleo"  for more details.
...
In order to make the program work, you must do the following :
 ...
 + EWARM
    - Open the STM32L152_Nucleo_Demo.eww workspace 
    - Rebuild all files: Project->Rebuild all
    - Load project image: Project->Debug
    - Run program: Debug->Go(F5)

 + MDK-ARM
    - Open the STM32L152_Nucleo_Demo.uvproj project
 ...
 + TrueSTUDIO:
    ...
    - Browse to the TrueSTUDIO workspace directory, select the project STM32L152_Nucleo_Demo to configure the project for Ultra Low Power XL-density Devices.
