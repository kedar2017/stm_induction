...
to 1, TIM2CLK = PCLK1 = HCLK = SystemCoreClock.
...
The minimum frequency value to measure is 488 Hz (TIM2 counter clock / CCR MAX).
...
@par Hardware and Software environment
  ...
  - STM32NUCLEO Set-up
    - Connect the external signal to measure to the TIM2 CH2 pin (PA.01). PA.01 is
      connected to pin A1 on the arduino connector.
...
In order to make the program work, you must do the following :
 ...
 + TrueSTUDIO:
    ...
    - Browse to the TrueSTUDIO workspace directory, select the project TIM_PWMInput.
