...
In order to make the program work, you must do the following :
 ...
 + EWARM
    - Open the STM32F030_Nucleo_Demo.eww workspace 
    - Rebuild all files: Project->Rebuild all
    - Load project image: Project->Debug
    - Run program: Debug->Go(F5)

 + MDK-ARM
    - Open the STM32F030_Nucleo_Demo.uvproj project
 ...
 + TrueSTUDIO:
    ...
    - Browse to the TrueSTUDIO workspace directory, select the project STM32F030_Nucleo_Demo.
