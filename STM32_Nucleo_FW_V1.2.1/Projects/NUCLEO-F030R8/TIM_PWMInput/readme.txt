...
The minimum frequency value to measure is 1099Hz (TIM2 counter clock / CCR MAX).

@par Note

  - For STM32F030, TIM3 is used.
...
@par Hardware and Software environment
  ...
  - STM32NUCLEO Set-up
    - Connect the external signal to measure to the TIM3 CH2 pin (PA.07). PA.07 is
      connected to pin D11 on the arduino connector. 
